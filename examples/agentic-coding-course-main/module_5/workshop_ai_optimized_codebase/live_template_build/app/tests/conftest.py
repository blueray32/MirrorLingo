...
async def test_db_engine():
    ...
    This fixture ensures each test gets an engine bound to its own event loop,
    preventing "Future attached to different loop" errors when pytest-asyncio
    creates new event loops for proper test isolation.
